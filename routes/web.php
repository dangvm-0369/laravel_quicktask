...
Route::controller(CarController::class)->middleware('admin')->group(function (){
    Route::get('/cars/', 'index')->name('cars.index');
    Route::get('/users/{user}/cars/create', 'create')->name('cars.create');
    Route::post('/users/{user}/cars/', 'store')->name('cars.store');
